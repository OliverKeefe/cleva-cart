...
VALUES
    ...
    ('Spaghetti Pasta', (SELECT id FROM Allergen WHERE name = 'Gluten')),
    ('Tomato', (SELECT id FROM Allergen WHERE name = 'No Major Allergen')),
    ('Salt', (SELECT id FROM Allergen WHERE name = 'No Major Allergen'));
